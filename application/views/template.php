                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url("/ControllerDoseRequest/listDoseRequest") ?>"> Dose demandé</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url("/ControllerDoseRequest/pageInsertDoseRequest") ?>"> Nouvelle demande</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url("/ControllerDoseResponse/listDoseResponse") ?>">Vaccin reçu</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url("/ControllerPersons/pageNonVacciner") ?>">Personne non Vacciné</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url("/ControllerPersons/pagePersonne") ?>">Information Personne</a>
                                </li>
